...
N_CLASSES, N_TRIMMED_CONCEPTS = RIVAL10_CONFIG['N_CLASSES'], RIVAL10_CONFIG['N_TRIMMED_CONCEPTS']

def parse_arguments():
    parser = argparse.ArgumentParser(description='Train X -> C Concept Model')
    # Data/Paths
    parser.add_argument('--log_dir', default='models/RIVAL10', help='Directory to save logs and best model')
